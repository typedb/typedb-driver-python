...
from grakn.api.concept.type.role_type import RoleType, RemoteRoleType
from grakn.common.label import Label
from grakn.common.rpc.request_builder import role_type_get_relation_types_req, role_type_get_players_req
