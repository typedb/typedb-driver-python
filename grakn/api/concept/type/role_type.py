...
class RoleType(Type, ABC):
    ...
    @abstractmethod
    def as_remote(self, transaction: "GraknTransaction") -> "RemoteRoleType":
        pass
...
class RemoteRoleType(RemoteType, RoleType, ABC):
    ...
    @abstractmethod
    def get_supertypes(self) -> Stream[RoleType]:
        pass

    @abstractmethod
    def get_subtypes(self) -> Stream[RoleType]:
        pass
    ...
    @abstractmethod
    def get_relation_types(self) -> Stream["RelationType"]:
        pass

    @abstractmethod
    def get_players(self) -> Stream["ThingType"]:
        pass
