...
from typedb.common.exception import TypeDBClientException, BAD_ENCODING, BAD_ANNOTATION, HAS_TIMEZONE_INFO
...
def datetime_value(value: datetime):
    if value.tzinfo is not None:
        raise TypeDBClientException.of(HAS_TIMEZONE_INFO)
    value_proto = concept_proto.ConceptValue()
